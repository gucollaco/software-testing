...
describe('Triangle tests', function() {
    test('Check if invalid triangle is invalid', function() {
        const tri = new triangle(5, 1, -2)
        expect(tri.classify()).toEqual('invalid')
    })

    test('Check if invalid triangle is invalid', function() {
        const tri = new triangle(5, -1, 5)
        expect(tri.classify()).toEqual('invalid')
    })
    ...
    test('Check if invalid triangle is invalid', function() {
        const tri = new triangle(0, 0, 0)
        expect(tri.classify()).toEqual('invalid')
    })

    test('Check if invalid triangle is invalid', function() {
        const tri = new triangle(0, 1, 1)
        expect(tri.classify()).toEqual('invalid')
    })

    test('Check if invalid triangle is invalid', function() {
        const tri = new triangle(1, 0, 1)
        expect(tri.classify()).toEqual('invalid')
    })

    test('Check if invalid triangle is invalid', function() {
        const tri = new triangle(1, 1, 0)
        expect(tri.classify()).toEqual('invalid')
    })
    ...
    test('Check if isosceles triangle returns isosceles', function() {
        const tri = new triangle(1, 2, 2)
        expect(tri.classify()).toEqual('isosceles')
    })

    test('Check if isosceles triangle returns isosceles', function() {
        const tri = new triangle(2, 1, 2)
        expect(tri.classify()).toEqual('isosceles')
    })
